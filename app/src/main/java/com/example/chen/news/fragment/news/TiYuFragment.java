 ...
 */
public class TiYuFragment extends BaseNewsFragment {
    @Override
    public void initData() {
        HttpUtils.getInstance().create(IRetrofit.class).getNewsBean(HttpModel.TIYU,HttpModel.KEY).enqueue(new Callback<NewsBean>() {
            @Override
