 ...
 */
public class YuLeFragment extends BaseNewsFragment {
    @Override
    public void initData() {
        HttpUtils.getInstance().create(IRetrofit.class).getNewsBean(HttpModel.YULE,HttpModel.KEY).enqueue(new Callback<NewsBean>() {
            @Override
