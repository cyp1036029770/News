 ...
 */
public class ShiShangFragment extends BaseNewsFragment {
    @Override
    public void initData() {
        HttpUtils.getInstance().create(IRetrofit.class).getNewsBean(HttpModel.SHISHANG,HttpModel.KEY).enqueue(new Callback<NewsBean>() {
            @Override
