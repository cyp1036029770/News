 ...
 */
public class KeJiFragment extends BaseNewsFragment {
    @Override
    public void initData() {
        HttpUtils.getInstance().create(IRetrofit.class).getNewsBean(HttpModel.KEJI,HttpModel.KEY).enqueue(new Callback<NewsBean>() {
            @Override
