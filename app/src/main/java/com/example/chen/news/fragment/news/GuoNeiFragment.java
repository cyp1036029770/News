 ...
 */
public class GuoNeiFragment extends BaseNewsFragment {
    @Override
    public void initData() {
        HttpUtils.getInstance().create(IRetrofit.class).getNewsBean(HttpModel.GUONEI,HttpModel.KEY).enqueue(new Callback<NewsBean>() {
            @Override
