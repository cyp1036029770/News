 ...
 */
public class JunShiFragment extends BaseNewsFragment {
    @Override
    public void initData() {
        HttpUtils.getInstance().create(IRetrofit.class).getNewsBean(HttpModel.JUNSHI,HttpModel.KEY).enqueue(new Callback<NewsBean>() {
            @Override
