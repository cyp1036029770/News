 ...
 */
public class SheHuiFragment extends BaseNewsFragment {
    @Override
    public void initData() {
        HttpUtils.getInstance().create(IRetrofit.class).getNewsBean(HttpModel.SHEHUI,HttpModel.KEY).enqueue(new Callback<NewsBean>() {
            @Override
