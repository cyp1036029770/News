 ...
 */
public class TopNewsFragment extends BaseNewsFragment {
    @Override
    public void initData() {
        HttpUtils.getInstance().create(IRetrofit.class).getNewsBean(HttpModel.TOP,HttpModel.KEY).enqueue(new Callback<NewsBean>() {
            @Override
